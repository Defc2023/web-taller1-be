        ...
        <div className="flex items-center gap-5">
          ...
          <UploadButton
            ...
            onClientUploadComplete={(res) => {
              if (res?.[0]) {
                setUploadedAvatarUrl(res[0].ufsUrl);
                setAvatarPreview(res[0].ufsUrl);
                showToast("Foto de perfil subida con éxito");
              }
            }}
            onUploadError={(err) => {
            ...
            appearance={{
              button: "bg-transparent text-blue-500 text-sm font-semibold hover:text-blue-700 ut-uploading:text-blue-400",
